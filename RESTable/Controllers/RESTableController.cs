...
{
    [RESTableRouteParser(Order = 0)]
    [RESTableOwinTokenAuthorizationFilter(Order = 1)]
    [RESTableAuthorizationFilter(Order = 2)]
    [RESTableExceptionHandler(Order=3)]
    public class RESTableController : ApiController
    {
        public IHttpActionResult Get()
        {
            return Get(ControllerContext.RouteData.Values["path"].ToString());
        }

        [HttpPost]
        public IHttpActionResult Post()
        {
            return Create(ControllerContext.RouteData.Values["path"].ToString());
        }

        [HttpPut]
        public IHttpActionResult Put()
        {
            return Update(ControllerContext.RouteData.Values["path"].ToString());
        }

        [HttpDelete]
        public IHttpActionResult Delete()
        {
            return Delete(ControllerContext.RouteData.Values["path"].ToString());
        }
